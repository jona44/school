    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('student', 'STUDENT'), ('teacher', 'TEACHER'), ('school_admin', 'SCHOOL_ADMIN'), ('school_head', 'SCHOOL_HEAD'), ('district_admin', 'DISTRICT_ADMIN')], max_length=30)),
