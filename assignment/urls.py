...
urlpatterns = [
    path('create_assignment/<subject_id>/', views.create_assignment, name='create_assignment'),  
    path('delete_assignment/<int:assignment_id>/', views.delete_assignment, name='delete_assignment'),
    path('assignments_list/<subject_id>/', views.assignments_list, name='assignments_list'),
